...
//     <Calendar size={64} style={{ color: COLORS.text.tertiary, marginBottom: 16 }} />
...
// const ActionMenu = ({ holiday, onView, onEdit, onDelete, canView, canUpdate, canDelete: canDeletePermission }) => {
...
//     return hasPermission(userPermissions, MODULES.HOLIDAY_MANAGEMENT, PAGES.HOLIDAY_MANAGEMENT, action);
//   };
...
//       loadHolidaysFromAPI();
//     }
//   }, [loadHolidaysFromAPI, permissionsLoaded, canView, isSuperAdmin]);
...
//         batches: newHoliday.batches || [],
//         created_at: newHoliday.created_at,
//         updated_at: newHoliday.updated_at
//       };
...
//       batches: updatedHoliday.batches || [],
//       created_at: updatedHoliday.created_at,
//       updated_at: updatedHoliday.updated_at
//     };
...
//             {/* Add Holiday Button - Only show if user has create permission */}
//             {canCreate && (
//               <Button
//                 variant="contained"
