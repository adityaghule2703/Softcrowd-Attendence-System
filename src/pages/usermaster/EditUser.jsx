...
const EditUser = ({ open, onClose, user, onUpdate, roles = [] }) => {
  ...
  useEffect(() => {
    if (user && open) {
      ...
      const role = availableRoles.find(r => r.id === user.RoleId || r.RoleName === user.RoleName);
    ...
    >
      ...
      <DialogActions sx={{
        ...
        <Button
          ...
          disabled={loading || !formData.RoleId || !formData.Username.trim() || !formData.Email.trim()}
